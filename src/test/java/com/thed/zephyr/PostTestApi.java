...
public class PostTestApi
    extends TestCase
{   
    //Errors? Questions? https://crossbrowsertesting.com/contact

    //VARIABLES
    //CrossBrowserTesting Credentials
    ...
    //Jira credentials
    //Password might need to be an api key set up by you.
    public final String jiraUsername = "";
    public final String jiraPassword = "";
    public final String jiraURL = ""; //Ex : {place-dev}.atlassian.net/rest/api/2/

    public final String versionName = "1.0";      

    //Jira Variables
    //The card name is generated by the Jenkins test. The path follows this scheme Package.ProgramName.TestName
    //If you get this wrong don't worry. After the first run you're card will be created and you can get the name.
    public final String cardName = ""; //For our example com.thed.zephyr.AppTest.testApp
    public final String projectTag = ""; //Ex: ZEP 
    public final String zephyrCycleName = ""; //this is set by jenkins under the configure tab.  //Ex: Our Zehpyr Cycle
    ...
    public static void main(String[] args) throws Exception {
      PostTestApi app = new PostTestApi();
      app.testApp();
    }

    public void testApp() throws Exception {
      //Sleep 15 seconds just to ensure Zephyr's data made it to jira.
      Thread.sleep(15000);

      //GATHER JIRA INFO
      
      String values[] = getJiraInfo();
      ...
      //File paths will be set in your AppTest.java CBT test
      String filePath = ""; //Ex: /Users/you/.jenkins/workspace/JenkinsZephyrAutomationProject/test/google.png
    ...
    public String[] getJiraInfo() throws Exception{
      ...
      Response response = ClientBuilder.newClient()
        .target(jiraURL + "search?jql=project=" + projectTag +"&fields=key,summary,description&maxResults=1000")
        .register(feature)
        .request()
      ...
      JSONObject allIssuesObj = new JSONObject(response.readEntity(String.class));
      JSONArray allIssues = allIssuesObj.getJSONArray("issues");
      for (int i=0; i < allIssues.length(); i++){
        JSONObject singleIssue = allIssues.getJSONObject(i);
        JSONObject issueField = singleIssue.getJSONObject("fields");
        String issueSummary = issueField.getString("summary");
        if (issueSummary.equals(cardName)){
          issueTag = singleIssue.getString("key");
        }
      }

      response = ClientBuilder.newClient()
        .target(jiraURL + "issue/" + issueTag)
        .register(feature)
        .request()
        //.header("Content-Type", "text/plain")
        .get();
      ...
      response = ClientBuilder.newClient()
        .target(jiraURL + "project/" + projectId)
        .register(feature)
        .request()
        //.header("Content-Type", "text/plain")
        .get();
    ...
    public String cbtHistoryLink() throws Exception{
      ...
      Response response = ClientBuilder.newClient()
        ...
        JSONObject seleniumHistoryObj = seleniumHistoryArr.getJSONObject(0);
